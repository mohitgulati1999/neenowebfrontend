...
const Departments = () => {
  ...
  const handleApplyClick = () => {
    console.log('handleApplyClick triggered'); // Debug: Check if this function runs
    if (dropdownMenuRef.current) {
      console.log('dropdownMenuRef exists:', dropdownMenuRef.current); // Debug: Verify ref is assigned
      dropdownMenuRef.current.classList.remove("show");
    } else {
      console.log('dropdownMenuRef is null'); // Debug: Check if ref is null
    }
  };
          ...
          <div className="d-flex align-items-center">
            <div className="dropdown">
              <Link
                ...
                aria-expanded="false"
                onClick={() => console.log('Dropdown trigger clicked')} // Debug: Check if click event fires
              >
              ...
              <ul className="dropdown-menu dropdown-menu-right p-3">
                <li>
                  <Link
                    ...
                    onClick={() => console.log('Edit option clicked')} // Debug: Check if Edit is clicked
                  >
                ...
                <li>
                  <Link
                    ...
                    onClick={() => console.log('Delete option clicked')} // Debug: Check if Delete is clicked
                  >
  ...
  // Debug: Check if component mounts and data is available
  console.log('Departments component rendered, data:', data);
  return (
    <div>
